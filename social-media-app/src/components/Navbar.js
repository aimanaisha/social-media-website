    ...
    <header>
        ...
        <div className={classes.ul}>
          <div className={classes.left}>
            <div>
              <Link to='/home' className={classes.li}><img src={home} className={classes.image} alt=''/></Link>
            </div> 
            <div>
              <Link to='/profile' className={classes.li}><img src={profile} alt='' className={classes.image}/></Link>
            </div>
          </div>          
          <div>
            <Link to='/login' >
              <button onClick={logoutHandler} className={classes.button}><img src={logOut} className={classes.image} alt=''/></button>
            </Link>
          </div>          
        </div>
      </nav>
